...
<head>
  ...
  <title>RESEARCHMENTOR | Flagship Atelier</title>
  <meta name="description" content="Discover Researchmentor at 181 Mercer Street, NYC. Dedicated to Doctoral Research Mentorship & Academic Thesis Pedagogy and artisanal excellence.">
...
<header class="site-header">
  <div class="container header-inner">
    <a href="index.php" class="brand-logo">RESEARCHMENTOR</a>
...
<div class="mobile-drawer" id="mobile-drawer">
  <div class="drawer-header">
    <span class="brand-logo">RESEARCHMENTOR</span>
    ...
    <div class="container" style="display:grid; grid-template-columns:1.2fr 0.8fr; gap:3.5rem; align-items:center;">
      ...
      <div style="position:relative;">
        <div style="border-radius:var(--radius-md); overflow:hidden; border:1px solid var(--border-strong); box-shadow:0 25px 50px -12px rgba(0,0,0,0.7);">
          <img src="assets/images/researchmentor_asset_1.jpg" alt="20170420 Beinecke Rare Book Library" style="width:100%; height:500px; object-fit:cover;">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-pad">
    <div class="container">
      ...
      <div class="grid-3">
        <div class="card">
          <img src="assets/images/researchmentor_asset_2.jpg" alt="Abdul Karim Sahityavisharad Referen">
          <div class="card-body">
        ...
        <div class="card">
          <img src="assets/images/researchmentor_asset_3.jpg" alt="Administration at Chattogram Univer">
          <div class="card-body">
        ...
        <div class="card">
          <img src="assets/images/researchmentor_asset_4.jpg" alt="Chung Hua University Library 5F int">
          <div class="card-body">
  ...
  <section class="section-pad">
    <div class="container">
      <div class="section-header">
        ...
        <p style="color:var(--text-secondary);">Tailored commissions engineered for connoisseurs of Doctoral Research Mentorship & Academic Thesis Pedagogy.</p>
      </div>
      <div class="grid-2">
        <div class="card" style="display:grid; grid-template-columns:1fr 1fr; align-items:center;">
          <img src="assets/images/researchmentor_asset_5.jpg" alt="Cornell University Interior Uris" style="height:100%; object-fit:cover;">
          <div class="card-body">
        ...
        <div class="card" style="display:grid; grid-template-columns:1fr 1fr; align-items:center;">
          <img src="assets/images/researchmentor_asset_6.jpg" alt="Cornell University Interior Uris" style="height:100%; object-fit:cover;">
          <div class="card-body">
  ...
  <section class="section-pad" style="background:var(--bg-surface); border-top:1px solid var(--border-subtle); border-bottom:1px solid var(--border-subtle);">
    <div class="container" style="display:grid; grid-template-columns:1fr 1.1fr; gap:4rem; align-items:center;">
      <div style="display:grid; grid-template-columns:1fr 1fr; gap:1.5rem;">
        <img src="assets/images/researchmentor_asset_7.jpg" alt="Duke Humfrey s Library Interior 1" style="border-radius:var(--radius-md); height:280px; width:100%; object-fit:cover;">
        <img src="assets/images/researchmentor_asset_8.jpg" alt="Duke Humfrey s Library Interior 2" style="border-radius:var(--radius-md); height:280px; width:100%; object-fit:cover; margin-top:2rem;">
      </div>
      <div>
        <span class="eyebrow">The Atelier Chronicle</span>
        <h2>A Tradition of Patient Hands in the Heart of SoHo</h2>
        <p style="color:var(--text-secondary); line-height:1.8; margin-bottom:1.5rem;">Since our founding at 181 Mercer Street, Researchmentor has stood as a bastion of tactile discipline. While commercial entities pursue automated shortcuts, our workshop remains committed to the slow, meditative cadence of traditional hand finishing.</p>
        ...
        <table class="spec-table">
          <thead>
            <tr>
              ...
              <th>Our Flagship Atelier (RESEARCHMENTOR)</th>
            </tr>
          </thead>
          <tbody>
            <tr>
  ...
  <section class="section-pad" style="background:var(--bg-surface); border-top:1px solid var(--border-subtle); border-bottom:1px solid var(--border-subtle);">
    <div class="container">
      <div class="section-header">
        ...
        <p style="color:var(--text-secondary);">Unsolicited feedback from patrons who demand uncompromised excellence in Doctoral Research Mentorship & Academic Thesis Pedagogy.</p>
      </div>
      <div class="grid-3">
        <div class="quote-card">
          <p class="quote-text">"The bespoke execution delivered by Researchmentor is extraordinary. The tactile feel and flawless balance prove their unwavering adherence to classical hand methods."</p>
...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-bottom">
      <span>&copy; 2026 RESEARCHMENTOR. All rights reserved. Certified Handcrafted Static Architecture.</span>
